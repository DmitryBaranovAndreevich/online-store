...
export const brands = goods.products.reduce((priv: { [key: string]: number }, { brand }) => {
  return { ...priv, [brand]: brand in priv ? priv[brand] + 1 : 1 };
}, {});

export const categories = goods.products.reduce((priv: { [key: string]: number }, { category }) => {
  return { ...priv, [category]: category in priv ? priv[category] + 1 : 1 };
}, {});
